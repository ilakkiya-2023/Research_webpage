...
def main_page():
    ...
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 6.04.21 PM.jpeg", use_column_width=True)
...
def content1_page():
    ...
    """, unsafe_allow_html=True)
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.07.45 PM.jpeg", use_column_width=True)
    ...
    """, unsafe_allow_html=True)
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.11.04 PM.jpeg", use_column_width=True)
    ...
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.15.43 PM.jpeg", use_column_width=True)
...
def content2_page():
    ...
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.44.16 PM.jpeg ", use_column_width=True)
...
The sequence is not fixed, as different variants of the fusion gene can occur, leading to different fusion protein sequences. However, the most common variant includes the first seven exons of the EWSR1 gene fused to exons 6-9 of the FLI1 gene.
    """, unsafe_allow_html=True)
    # st.image(" E:\mallene_project\WhatsApp Image 2024-08-27 at 7.44.41 PM (3).jpeg", use_column_width=True)
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.44.41 PM (3).jpeg ", use_column_width=True)
...
""")
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.21.51 PM.jpeg ", use_column_width=True)
    st.markdown("""
**YK-4-279:**
...
""")
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.37.26 PM.jpeg ", use_column_width=True)
    st.markdown("""
**Trabectedin:**
...
Clinical Status: BCL-2 inhibitors are under investigation for use in combination with other therapies in Ewing sarcoma.
    """, unsafe_allow_html=True)
    st.image("E:\mallene_project\WhatsApp Image 2024-08-27 at 7.43.07 PM.jpeg ", use_column_width=True)
